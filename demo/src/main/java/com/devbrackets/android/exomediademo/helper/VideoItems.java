...
//        items.add(new VideoItem("FLV - Big Buck Bunny by Blender", "http://www.sample-videos.com/video/flv/720/big_buck_bunny_720p_5mb.flv"));
        ...
        items.add(new VideoItem("TEST HLS AUDIO SYNC", "http://vod.ak.hls.ttvnw.net/v1/AUTH_system/vods_8240/fantabobshow_19554040496_400314265/chunked/index-muted-90W28YU1VN.m3u8"));
        items.add(new VideoItem("TEST HLS AUDIO SYNC 2", "http://vod.ak.hls.ttvnw.net/v1/AUTH_system/vods_600a/rpglimitbreak_19592162624_401381317/chunked/index-muted-AENJHXMNFM.m3u8"));
        items.add(new VideoItem("Rotation issue test", "https://dl.dropboxusercontent.com/s/8evvodziythdnw2/20160206_235342.mp4"));
    }
